...
class TestMixpeek:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.delete("/collections/collection_id").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.delete("/collections/collection_id").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.delete("/collections/collection_id").mock(side_effect=retry_handler)

        response = client.collections.with_raw_response.delete(collection_id="collection_id")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.collections.with_raw_response.delete(
            collection_id="collection_id", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.collections.with_raw_response.delete(
            collection_id="collection_id", extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncMixpeek:
    ...
    async def test_retries_taken(
        ...
        response = await client.collections.with_raw_response.delete(collection_id="collection_id")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.collections.with_raw_response.delete(
            collection_id="collection_id", extra_headers={"x-stainless-retry-count": Omit()}
        )
