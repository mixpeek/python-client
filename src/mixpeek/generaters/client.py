...
class GeneratersClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def generate_generate_post(
        self,
        *,
        model: Model,
        ...
        client.generaters.generate_generate_post(
            model=Model(
                provider="provider",
                model="model",
            ),
...
class AsyncGeneratersClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def generate_generate_post(
        self,
        *,
        model: Model,
        response_format: typing.Optional[typing.Dict[str, typing.Any]] = OMIT,
        ...
        await client.generaters.generate_generate_post(
            model=Model(
                provider="provider",
                model="model",
            ),
