...
class ParsersClient:
    ...
    def parse_file_parsers_post(
        ...
        *,
        ...
        client.parsers.parse_file_parsers_post()
        """
...
class AsyncParsersClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def parse_file_parsers_post(
        self,
        *,
        file_url: typing.Optional[str] = OMIT,
        contents: typing.Optional[str] = OMIT,
        ...
        await client.parsers.parse_file_parsers_post()
        """
        _request: typing.Dict[str, typing.Any] = {}
        if file_url is not OMIT:
            _request["file_url"] = file_url
